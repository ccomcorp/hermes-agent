...
- **[DocOps (DOX)](docops.md)** — Project-local documentation maintenance for agent contracts, changelogs, status files, and report-pack skeletons via `hermes dox init`, `check`, `status`, and `closeout`.
