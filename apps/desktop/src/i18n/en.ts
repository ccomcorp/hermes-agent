...
export const en: Translations = {
  ...
  settings: {
    ...
    delegation: {
      advisorTitle: 'Route Advisor',
      advisorDesc:
        'The Route Advisor evaluates subagent tasks and suggests the best provider and model lane. It never auto-dispatches — it only logs or nudges the agent.',
      advisorMode: 'Mode',
      advisorModeOff: 'Off',
      advisorModeLog: 'Log',
      advisorModeNudge: 'Nudge',
      advisorMinLevel: 'Min Level',
      advisorMinLevelModerate: 'Moderate',
      advisorMinLevelComplex: 'Complex',
      advisorMinLevelExpert: 'Expert',
      advisorCooldown: 'Cooldown (turns)',
      noRoutes: 'No lane routes configured',
      routeCount: count => `${count} lane${count === 1 ? '' : 's'}`,
      seedButton: 'Seed suggested lanes',
      seeding: 'Seeding…',
      seededTitle: 'Lanes seeded',
      seededMessage: 'Suggested lanes have been added from your current config pins.',
      seedFailed: 'Could not seed lanes.',
      emptyTitle: 'No lanes',
      emptyDesc: 'Add a lane to route subagent tasks to a specific provider and model.',
      addLane: 'Add lane',
      addLaneTitle: 'New delegation lane',
      editLaneTitle: 'Edit delegation lane',
      editLaneDesc: 'Each lane maps a task kind to a specific provider and model.',
      laneName: 'Lane name',
      laneProvider: 'Provider',
      laneModel: 'Model',
      laneEffort: 'Reasoning effort',
      laneDescription: 'Description',
      laneDescriptionPlaceholder: 'e.g. "Code generation for Python projects"',
      laneBaseUrl: 'Base URL',
      laneApiKey: 'API key',
      laneApiMode: 'API mode',
      apiKeyHint: 'Leave empty to inherit, or use ${VAR} to reference a secret',
      ...
      deleteDesc: (name: string) => `Delete the "${name}" delegation lane? This cannot be undone.`,
      deleteConfirm: 'Delete',
      colName: 'Name',
      ...
      apiModeOpenAI: 'OpenAI-compatible',
      apiModeAnthropic: 'Anthropic',
      apiModeGemini: 'Gemini',
      saveEffectNote:
        'New lanes appear in new chat sessions. Model changes behind existing lanes take effect on the next delegation \u2014 even in this session.'
    },
    sessions: {
  ...
  sidebar: {
    ...
    row: {
      ...
      moveNoProjects: 'No projects with a folder yet',
      moveNewProject: 'New project…',
      moveNewProjectTitle: 'Move to a new project',
      moveNewProjectDesc:
        'Create a named project and re-home this chat under its folder. Projects own sessions by workspace path.',
      moveProjectName: 'Project name',
      moveProjectFolder: 'Project folder',
      moveProjectFolderPlaceholder: 'Path to the project workspace',
      moveBrowse: 'Browse',
      moveCreateAndMove: 'Create & move',
      movedToProject: name => `Moved to ${name}`,
      moveFailed: 'Could not move session',
      moveNoFolder: 'This project has no folder yet — add a folder first',
      moveNoGateway: 'Gateway not connected',
      moveCreateFailed: 'Could not create project',
      ageNow: 'now',
      ageDay: 'd',
      ageHour: 'h',
      ageMin: 'm'
